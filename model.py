...
class ModelOver():
    ...
    def finish_over(self):
        out_file = self.out_file
        if not os.path.exists(out_file):
            os.makedirs(out_file)
        file_D = self.file_D
        file_D_1 = self.file_D_1
        file_D_2 = self.file_D_2
        file_D_3 = self.file_D_3
        file_D_4 = self.file_D_4
        file_D_5 = self.file_D_5
        file_D_6 = self.file_D_6
        file_D_7 = self.file_D_7
